...
class AppColors {
  ...
  static final Color shade = Color(0x26000000);
  ...
  //Blues
  static final Color lightBlue = Color(0xFF6DB3F2);
  static final Color blue = Color(0XFF3690F0);
  static final Color darkBlue = Color(0XFF1E69DE);
